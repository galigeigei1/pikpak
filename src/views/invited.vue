    ...
    <n-row>
      ...
      <n-col :span="12">
        <n-statistic label="邀请链接" >
          ...
          <template #default>
            <n-space inline>
              <n-input type="text" size="small" :value="'https://toapp.mypikpak.com/activity/invited?code=651531'"></n-input>
              <n-button size="small" type="primary" @click="copy('https://toapp.mypikpak.com/activity/invited?code=651531')">复制</n-button>
            </n-space>
            <n-input-group >
            </n-input-group>
          </template>
